    ...
    <body id="page-top" class="index">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="page-scroll">
                            <a href="#portfolio">O que é</a>
                        </li>
                        <li class="page-scroll">
                            <a href="#about">Como é</a>
                        </li>
                        <li class="page-scroll">
                            <a href="#contact">Quem fez</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
        ...
        <footer class="text-center">
            <div class="footer-above">
                <div class="container">
                    <div class="row">
                        <div class="footer-col col-lg-6 col-md-offset-3">
                    ...
                    <div class="row">
                        <div class="footer-col col-lg-6 text-center col-md-offset-3">
            ...
            <div class="footer-below">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            Copyright &copy; GambiarraMarota 2014
                        </div>
                    </div>
                </div>
            </div>
